...
describe('CardDisplayerComponent', () => {
    ...
    it('should delete game', () => {
        ...
        const getCurrentPageCardsSpy = spyOn(component, 'getCurrentPageCards');
        component.onGameDeleted(gameMock);
        expect(getCurrentPageCardsSpy).toHaveBeenCalled();
    });

    it('should display max 4 game cards by page', () => {
        component.allCards.length = 0;
        spyOn(component, 'getCurrentPageCards');
        component.getCurrentPageCards();
        expect(component.getCurrentPageCards).toHaveBeenCalled();
    });
});
